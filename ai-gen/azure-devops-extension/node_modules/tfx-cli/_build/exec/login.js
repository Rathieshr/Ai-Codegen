        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.commandArgs.serviceUrl.val().then(function (collectionUrl) { return __awaiter(_this, void 0, void 0, function () {
                        var skipCertValidation, authHandler, webApi, locationsApi, connectionData, tfxCredStore, tfxCache, credString, err_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.commandArgs.skipCertValidation.val(false)];
                                case 1:
                                    skipCertValidation = _a.sent();
                                    return [4 /*yield*/, this.getCredentials(collectionUrl, false)];
                                case 2:
                                    authHandler = _a.sent();
                                ...
                                case 8:
                                    _a.sent();
                                    return [4 /*yield*/, tfxCache.setItem("cache", "skipCertValidation", skipCertValidation.toString())];
                                case 9:
                                    _a.sent();
