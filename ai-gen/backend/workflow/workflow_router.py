...
def route_work_item_to_template(
    work_item: dict[str, Any],
    refinement: dict[str, Any] | None = None,
    effective_context: dict[str, Any] | None = None,
) -> tuple[dict[str, str], dict[str, Any]]:
    classification = classify_work_item(work_item, refinement=refinement, effective_context=effective_context)
...
def select_workflow_template(
    ...
    classification = classify_work_item(work_item, refinement=refinement, effective_context=effective_context)
    return get_pipeline_template(classification["recommended_template"])
