...
class AzurePhiProvider:
    ...
    def final_url(self) -> str:
        ...
        return f"{base}{normalized_path}?api-version={urllib.parse.quote(self.api_version, safe='')}"
    ...
    def _attempt_request(
        ...
        try:
            ...
            with urllib.request.urlopen(request, timeout=timeout_seconds) as response:
                ...
                print(
                    "ai-gen phi probe "
                    f"http_status={http_status} response_length={len(response_body)} elapsed_ms={elapsed_ms}"
                )
