...
var TfCommand = /** @class */ (function () {
    ...
    TfCommand.prototype.getWebApi = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var tfxCache, skipCertValidation;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        tfxCache = new diskcache_1.DiskCache("tfx");
                        return [4 /*yield*/, tfxCache.itemExists("cache", "skipCertValidation")];
                    case 1:
                        if (!_a.sent()) return [3 /*break*/, 3];
                        return [4 /*yield*/, tfxCache.getItem("cache", "skipCertValidation")];
                    case 2:
                        skipCertValidation = _a.sent();
                        options = __assign({}, options, { ignoreSslError: skipCertValidation });
                        _a.label = 3;
                    case 3: return [2 /*return*/, this.commandArgs.serviceUrl.val().then(function (url) {
                            return _this.getCredentials(url).then(function (handler) {
                                _this.connection = new connection_1.TfsConnection(url);
                                _this.webApi = new WebApi_1.WebApi(url, handler, options);
                                return _this.webApi;
                            });
                        })];
                }
                        ...
                        if (continuedHierarchy === null) {
                            ...
                            return [2 /*return*/, loader
                                    ...
                                    if (_this.serverCommand) {
                                        ...
                                        ["authType", "username", "password", "token", "serviceUrl", "fiddler", "proxy", "skipCertValidation"].forEach(function (arg) {
