...
class AzureDevOpsSynchronizationMilestone62Tests(unittest.TestCase):
    ...
    def test_sync_api_exposes_status_history_webhook_and_reconcile(self):
        ...
        status_response = api.get("/integrations/azure-devops/projects/p1/sync-status")
        self.assertEqual(200, status_response.status_code)
        self.assertEqual("Completed", status_response.json()["latestSync"]["status"])
        self.assertGreater(status_response.json()["collectionCounts"]["workItems"], 0)
