...
var deprecatedRunners = ["Node6", "Node10", "Node16"];
/*
 ...
 */
function validateRunner(taskData) {
    if (taskData == undefined || taskData.execution == undefined)
        return;
    var validRunnerCount = Object.keys(taskData.execution).filter(function (itm) { return deprecatedRunners.indexOf(itm) == -1; }) || 0;
